...
describe('Color named', () => {
  ...
  test('Textcolor nested', () => {
    expect(tex2mml('\\textcolor{red}{\\textcolor{blue}{a} b}')).toMatchSnapshot();
  });
  ...
  test('Definecolor', () => {
    expect(tex2mml('\\definecolor{test}{named}{#48C}\\color{test} a')).toMatchSnapshot();
  });
...
describe('Color rgb', () => {
  ...
  test('Textcolor nested', () => {
    expect(tex2mml('\\textcolor[rgb]{1,0,0}{\\textcolor[rgb]{0,0,1}{a} b}')).toMatchSnapshot();
  });
  ...
  test('Fcolorbox', () => {
    expect(tex2mml('\\fcolorbox[rgb]{1,0,0}[rgb]{1,1,0}{a b}')).toMatchSnapshot();
  });

  /********************************************************************************/

  test('Definecolor', () => {
    expect(tex2mml('\\definecolor{test}{rgb}{.25,.5,.75}\\color{test} a')).toMatchSnapshot();
  });
...
describe('Color RGB', () => {
  ...
  test('Textcolor nested', () => {
    expect(tex2mml('\\textcolor[RGB]{255,0,0}{\\textcolor[RGB]{0,0,255}{a} b}')).toMatchSnapshot();
  });
  ...
  test('Fcolorbox', () => {
    expect(tex2mml('\\fcolorbox[RGB]{255,0,0}[RGB]{255,255,0}{a b}')).toMatchSnapshot();
  });

  /********************************************************************************/

  test('Definecolor', () => {
    expect(tex2mml('\\definecolor{test}{RGB}{8,128,200}\\color{test} a')).toMatchSnapshot();
  });
...
describe('Color gray', () => {
  ...
  test('Textcolor nested', () => {
    expect(tex2mml('\\textcolor[gray]{.5}{\\textcolor[gray]{.75}{a} b}')).toMatchSnapshot();
  });
  ...
  test('Definecolor', () => {
    expect(tex2mml('\\definecolor{test}{gray}{.02}\\color{test} a')).toMatchSnapshot();
  });
