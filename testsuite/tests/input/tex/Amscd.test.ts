...
describe('AmsCD', () => {
  ...
  it('AmsCD-1', () => {
    expect(tex2mml('\\begin{CD}A @>a>> B\\\\@VVbV @VVcV\\\\C @>d>> D\\end{CD}')).toMatchSnapshot();
  });

  it('AmsCD-2', () => {
    expect(tex2mml('\\begin{CD}A @<<< B @>>> C\\\\@. @| @AAA\\\\@. D @= E\\end{CD}')).toMatchSnapshot();
  });

  it('AmsCD-3', () => {
    expect(tex2mml('\\begin{CD}A @>a>b> B\\\\@VlVrV @AlArA\\\\C @<a<b< D\\end{CD}')).toMatchSnapshot();
  });
