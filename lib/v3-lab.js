...
/**
 * A mixin to add complexity() and explorable() to a document so that
 * the checkboxes can control their functions.
 *
...
function V3DocumentMixin(documentClass) {
    ...
    return class extends documentClass {
        ...
        /**
         * Call the superclass' complexity() or enrich() method, depending
         * on the checkbox settings.
         *
         * @override
         */
        complexity() {
        ...
        /**
         * Only add the Explorer if the checkbox is checked
         */
        explorable() {
            if (Lab.explore) {
                super.explorable();
...
const Lab = window.Lab = {
    ...
    Startup() {
        ...
        // Include the addMenu() call in the typeset functions at the appropriate time
        //
        const startup = MathJax.startup;
        startup.extendHandler(handler => this.menuHandler(handler), 20);
        startup.typesetCall('addMenu', 170);
        //
