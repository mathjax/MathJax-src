 ...
 */
BaseMethods.Linebreak = function (
  parser: TexParser,
  _name: string,
  linebreak: string,
) {
 ...
 */
BaseMethods.UnderOver = function (
  parser: TexParser,
  name: string,
  c: string,
  stack: boolean,
 ...
 */
BaseMethods.AlignedArray = function (
  parser: TexParser,
  begin: StackItem,
  style: string = '',
) {
...
BaseMethods.IndentAlign = function (parser: TexParser, begin: StackItem) {
  ...
  if (
    (first && !ParseUtil.matchDimen(first)[0]) ||
 ...
 */
BaseMethods.HandleRef = function (
  parser: TexParser,
  name: string,
  eqref: boolean,
) {
