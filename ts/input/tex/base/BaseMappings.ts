...
new sm.CommandMap('macros', {
  ...
  cases:             [BaseMethods.Matrix, '{', '', 'left left', null, '.2em', null,
                      true],
  eqalign:           [BaseMethods.Matrix, null, null, 'right left',
  ...
  eqalignno:         [BaseMethods.Matrix, null, null, 'right left',
                      THICKMATHSPACE, '.5em', 'D', null,
                      'right'],
  leqalignno:        [BaseMethods.Matrix, null, null, 'right left',
                      THICKMATHSPACE, '.5em', 'D', null,
                      'left'],
  ...
  bmod:              [BaseMethods.Macro, '\\mmlToken{mo}[lspace="' + THICKMATHSPACE + '"' +
                      ' rspace="' + THICKMATHSPACE + '"]{mod}'],
  pmod:              [BaseMethods.Macro, '\\pod{\\mmlToken{mi}{mod}\\kern 6mu #1}', 1],
  mod:               [BaseMethods.Macro, '\\mathchoice{\\kern18mu}{\\kern12mu}' +
                      '{\\kern12mu}{\\kern12mu}\\mmlToken{mi}{mod}\\,\\,#1',
                      1],
  pod:               [BaseMethods.Macro, '\\mathchoice{\\kern18mu}{\\kern8mu}' +
                      '{\\kern8mu}{\\kern8mu}(#1)', 1],
  ...
  LaTeX:             [BaseMethods.Macro, 'L\\kern-.325em\\raise.21em' +
...
new sm.EnvironmentMap('environment', ParseMethods.environment, {
  ...
  eqnarray:      [BaseMethods.EqnArray, null, true, true, 'rcl', 'bmt',
