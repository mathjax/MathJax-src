...
// required order.
BussproofsMethods.Prooftree = function (
  parser: TexParser,
  begin: StackItem,
): StackItem {
  parser.Push(begin);
 ...
 */
BussproofsMethods.Inference = function (
  parser: TexParser,
  name: string,
  n: number,
) {
 ...
 */
BussproofsMethods.Label = function (
  parser: TexParser,
  name: string,
  side: string,
) {
 ...
 */
BussproofsMethods.SetLine = function (
  parser: TexParser,
  _name: string,
  style: string,
  always: boolean,
 ...
 */
BussproofsMethods.RootAtTop = function (
  parser: TexParser,
  _name: string,
  where: boolean,
) {
 ...
 * @param {number} n Number of premises for this inference rule.
 */
BussproofsMethods.InferenceF = function (
  parser: TexParser,
  name: string,
  n: number,
) {
