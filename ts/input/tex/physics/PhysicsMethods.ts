 ...
 */
PhysicsMethods.Quantity = function (
  parser: TexParser,
  name: string,
  open: string = '(',
  close: string = ')',
 ...
 * @param {string=} close Closing fence.
 */
PhysicsMethods.Commutator = function (
  parser: TexParser,
  name: string,
  open: string = '[',
  close: string = ']',
 ...
 */
PhysicsMethods.StarMacro = function (
  parser: TexParser,
  name: string,
  argcount: number,
  ...parts: string[]
 ...
 */
PhysicsMethods.Expression = function (
  parser: TexParser,
  name: string,
  opt: boolean = true,
  id: string = '',
 ...
 */
PhysicsMethods.Qqtext = function (
  parser: TexParser,
  name: string,
  text: string,
) {
  ...
  parser.string =
    parser.string.slice(0, parser.i) + replace + parser.string.slice(parser.i);
};
 ...
 */
PhysicsMethods.Differential = function (
  parser: TexParser,
  name: string,
  op: string,
) {
 ...
 */
PhysicsMethods.Derivative = function (
  parser: TexParser,
  name: string,
  argMax: number,
  op: string,
 ...
 */
PhysicsMethods.MatrixQuantity = function (
  parser: TexParser,
  name: string,
  small?: boolean,
) {
 ...
 */
PhysicsMethods.DiagonalMatrix = function (
  parser: TexParser,
  name: string,
  anti?: boolean,
) {
 ...
 */
PhysicsMethods.AutoClose = function (
  parser: TexParser,
  fence: string,
  texclass: number,
): ParseResult {
  ...
  parser.Push(
    parser.itemFactory.create('close').setProperties({ 'pre-autoclose': true }),
  );
  parser.Push(
