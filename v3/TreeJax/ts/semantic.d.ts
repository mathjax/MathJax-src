declare module 'semantic' {
  ...
  export class NodeFactory {
    ...
    public makeBranchNode(kind: string, children: Node[], content: Node[]): Node;
  ...
  namespace Processor {
    ...
    export function identifierNode(content: string, font: string, kind: string): Node;
    export function fractionLikeNode(linethickness: string, denom: Node, enume: Node): Node;
    export function limitNode(tag: string, nodes: Node[]): Node;
    export function text(content: string, font: string, kind: string): Node;
    export function number(node: Node): Node;
    export function mfenced(open: string, close: string, sepValue: string, nodes: Node[]): Node;
    export function tablesInRow(nodes: Node[]): Node;
    export function tableToMultiline(table: Node): Node;
    export function pseudoTensor(base: Node, sub: Node[], sup: Node[]): Node;
    export function tensor(base: Node, lsub: Node[], lsup:Node[], rsub: Node[], rsup:Node[]): Node;
  }
