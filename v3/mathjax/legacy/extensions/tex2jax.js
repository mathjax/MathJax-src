...
//    ['$','$'],               //  (comment out any you don't want, or add your own, but
  ...
  //
  ignoreTags: {
    br: (MathJax.Hub.Browser.isMSIE && HTML.document.documentMode < 9 ? "\n" : " "),
    wbr: "",
    "#comment": ""
  },
  ...
  PreProcess: function (element) {
    ...
    if (typeof(element) === "string") {element = HTML.document.getElementById(element)}
    if (!element) {element = HTML.document.body}
