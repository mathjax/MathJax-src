...
// Namespace
let ParseMethods: Record<string, ParseMethod> = {};
 ...
 */
ParseMethods.Tilde = function(parser: TexParser, c: string) {
  // @test Tilde, Tilde2
  //
...
ParseMethods.Space = function(parser: TexParser, c: string) {};

/*
 *  Handle ^, _, and '
 */
ParseMethods.Superscript = function(parser: TexParser, c: string) {
...
ParseMethods.Subscript = function(parser: TexParser, c: string) {
...
ParseMethods.Prime = function(parser: TexParser, c: string) {
  // @test Prime
 ...
 *  Handle comments
 */
ParseMethods.Comment = function(parser: TexParser, c: string) {
 ...
 */
ParseMethods.Hash = function(parser: TexParser, c: string) {
...
ParseMethods.SetFont = function(parser: TexParser, name: string, font: string) {
  parser.stack.env['font'] = font;
};

ParseMethods.SetStyle = function(parser: TexParser, name: string, texStyle: string, style: string, level: string) {
...
ParseMethods.Color = function(parser: TexParser, name: string) {
...
ParseMethods.Spacer = function(parser: TexParser, name: string, space: string) {
...
ParseMethods.LeftRight = function(parser: TexParser, name: string) {
...
ParseMethods.Middle = function(parser: TexParser, name: string) {
...
ParseMethods.NamedFn = function(parser: TexParser, name: string, id: string) {
...
ParseMethods.Limits = function(parser: TexParser, name: string, limits: string) {
...
ParseMethods.Frac = function(parser: TexParser, name: string) {
...
ParseMethods.Sqrt = function(parser: TexParser, name: string) {
...
ParseMethods.Root = function(parser: TexParser, name: string) {
...
ParseMethods.MoveRoot = function(parser: TexParser, name: string, id: string) {
...
ParseMethods.Accent = function(parser: TexParser, name: string, accent: string, stretchy: boolean) {
...
ParseMethods.UnderOver = function(parser: TexParser, name: string, c: string, stack: boolean, noaccent: boolean) {
...
ParseMethods.Overset = function(parser: TexParser, name: string) {
...
ParseMethods.Underset = function(parser: TexParser, name: string) {
...
ParseMethods.TeXAtom = function(parser: TexParser, name: string, mclass: number) {
...
ParseMethods.MmlToken = function(parser: TexParser, name: string) {
...
ParseMethods.Strut = function(parser: TexParser, name: string) {
...
ParseMethods.Phantom = function(parser: TexParser, name: string, v: string, h: string) {
...
ParseMethods.Smash = function(parser: TexParser, name: string) {
...
ParseMethods.Lap = function(parser: TexParser, name: string) {
...
ParseMethods.RaiseLower = function(parser: TexParser, name: string) {
...
ParseMethods.MoveLeftRight = function(parser: TexParser, name: string) {
...
ParseMethods.Hskip = function(parser: TexParser, name: string) {
...
ParseMethods.Rule = function(parser: TexParser, name: string, style: string) {
...
ParseMethods.rule = function(parser: TexParser, name: string) {
  TreeHelper.printMethod('rule');
  // @test Rule 2D
...
ParseMethods.MakeBig = function(parser: TexParser, name: string, mclass: number, size: number) {
...
ParseMethods.BuildRel = function(parser: TexParser, name: string) {
...
ParseMethods.HBox = function(parser: TexParser, name: string, style: string) {
  TreeHelper.printMethod('HBox');
  // @test Hbox
  parser.PushAll(parser.InternalMath(parser.GetArgument(name), style));
};

ParseMethods.FBox = function(parser: TexParser, name: string) {
...
ParseMethods.Not = function(parser: TexParser, name: string) {
...
ParseMethods.Matrix = function(parser: TexParser, name: string,
...
ParseMethods.Entry = function(parser: TexParser, name: string) {
...
ParseMethods.Cr = function(parser: TexParser, name: string) {
...
ParseMethods.HLine = function(parser: TexParser, name: string, style: string) {
...
ParseMethods.HFill = function(parser: TexParser, name: string) {
...
ParseMethods.BeginEnd = function(parser: TexParser, name: string) {
...
// ParseMethods.Equation = function(parser: TexParser, begin: string, row: MmlNode[]) {
//   return row;
// };

// ParseMethods.ExtensionEnv = function(parser: TexParser, begin,file) {
//   parser.Extension(begin.name,file,'environment');
// };

ParseMethods.Array = function(parser: TexParser, begin: sitem.StackItem,
                      open: string, close: string, align: string,
                      spacing: string, vspacing: string, style: string,
...
ParseMethods.AlignedArray = function(parser: TexParser, begin: sitem.StackItem) {
...
ParseMethods.Require = function(parser: TexParser, name: string) {
...
ParseMethods.Macro = function(parser: TexParser, name: string,
...
// mathchoice
ParseMethods.MathChoice = function(parser: TexParser, name: string) {
