...
export namespace AmsSymbols {
  ...
  sm.CharacterMap.create('AMSsymbols-mathchar0mi', BaseMethods.mathchar0mi, {
      ...
      varGamma:               ['0393',{mathvariant: TexConstant.Variant.ITALIC}],
      varDelta:               ['0394',{mathvariant: TexConstant.Variant.ITALIC}],
      varTheta:               ['0398',{mathvariant: TexConstant.Variant.ITALIC}],
      varLambda:              ['039B',{mathvariant: TexConstant.Variant.ITALIC}],
      varXi:                  ['039E',{mathvariant: TexConstant.Variant.ITALIC}],
      varPi:                  ['03A0',{mathvariant: TexConstant.Variant.ITALIC}],
      varSigma:               ['03A3',{mathvariant: TexConstant.Variant.ITALIC}],
      varUpsilon:             ['03A5',{mathvariant: TexConstant.Variant.ITALIC}],
      varPhi:                 ['03A6',{mathvariant: TexConstant.Variant.ITALIC}],
      varPsi:                 ['03A8',{mathvariant: TexConstant.Variant.ITALIC}],
      varOmega:               ['03A9',{mathvariant: TexConstant.Variant.ITALIC}],
...
//    hbar:                   '0127',  // in TeX/jax.js
      ...
      Diamond:                '25CA',
      blacklozenge:           '29EB',
      circledS:               ['24C8',{mathvariant: TexConstant.Variant.NORMAL}],
      bigstar:                '2605',
//    angle:                  '2220',  // in TeX/jax.js
      ...
      complement:             '2201',
      mho:                    '2127',
      eth:                    ['00F0',{mathvariant: TexConstant.Variant.NORMAL}],
      Finv:                   '2132',
      diagup:                 '2571',
      Game:                   '2141',
      diagdown:               '2572',
      Bbbk:                   ['006B',{mathvariant: TexConstant.Variant.DOUBLESTRUCK}],
