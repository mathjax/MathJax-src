...
import {CommonTeXAtom, CommonTeXAtomInterface} from '../../common/Wrappers/TeXAtom.js';
 ...
 */
export class CHTMLTeXAtom<N, T, D> extends CommonTeXAtom<N, T, D, CHTMLConstructor<N, T, D>>(CHTMLWrapper) {
