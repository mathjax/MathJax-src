...
describe('Unicode', () => {
  ...
  it('Unicode Font', () => toXmlMatch(tex2mml("\\unicode[Garamond]{x22D6}"),
  ...
  it('Unicode Combined', () => toXmlMatch(tex2mml("\\mbox{A}\\unicode{65}{B}"),
  ...
  it('Unicode Surrogate Hex', () => toXmlMatch(tex2mml("\\unicode{x1D5A0}"),
  ...
  it('Unicode Surrogate Dec', () => toXmlMatch(tex2mml("\\unicode{120224}"),
  ...
  it('Unicode Blackboard', () => toXmlMatch(tex2mml("\\unicode{x1D538}"),
  ...
  it('Unicode Blackboard Geramond', () => toXmlMatch(tex2mml("\\unicode{x1D538}"),
    "<math xmlns=\"http://www.w3.org/1998/Math/MathML\" data-latex=\"\\unicode{x1D538}\" display=\"block\">\n  <mtext data-latex=\"\\unicode{x1D538}\">&#x1D538;</mtext>\n</math>"
  ));
})
