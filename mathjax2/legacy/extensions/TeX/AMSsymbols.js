...
MathJax.Hub.Register.StartupHook("TeX Jax Ready",function () {
  ...
  var miMap = sm.CharacterMap.create('AMSsymbols-mathchar0mi', BaseMethods.mathchar0mi, {
      ...
      varGamma:               ['\u0393',{mathvariant: tc.TexConstant.Variant.ITALIC}],
      varDelta:               ['\u0394',{mathvariant: tc.TexConstant.Variant.ITALIC}],
      varTheta:               ['\u0398',{mathvariant: tc.TexConstant.Variant.ITALIC}],
      varLambda:              ['\u039B',{mathvariant: tc.TexConstant.Variant.ITALIC}],
      varXi:                  ['\u039E',{mathvariant: tc.TexConstant.Variant.ITALIC}],
      varPi:                  ['\u03A0',{mathvariant: tc.TexConstant.Variant.ITALIC}],
      varSigma:               ['\u03A3',{mathvariant: tc.TexConstant.Variant.ITALIC}],
      varUpsilon:             ['\u03A5',{mathvariant: tc.TexConstant.Variant.ITALIC}],
      varPhi:                 ['\u03A6',{mathvariant: tc.TexConstant.Variant.ITALIC}],
      varPsi:                 ['\u03A8',{mathvariant: tc.TexConstant.Variant.ITALIC}],
      varOmega:               ['\u03A9',{mathvariant: tc.TexConstant.Variant.ITALIC}],
...
//    hbar:                   '0127',  // in TeX/jax.js
      ...
      Diamond:                '\u25CA',
      blacklozenge:           '\u29EB',
      circledS:               ['\u24C8',{mathvariant: tc.TexConstant.Variant.NORMAL}],
      bigstar:                '\u2605',
//    angle:                  '\u2220',  // in TeX/jax.js
      sphericalangle:         '\u2222',
      measuredangle:          '\u2221',
      ...
      complement:             '\u2201',
      mho:                    '\u2127',
      eth:                    ['\u00F0',{mathvariant: tc.TexConstant.Variant.NORMAL}],
      Finv:                   '\u2132',
      diagup:                 '\u2571',
      Game:                   '\u2141',
      diagdown:               '\u2572',
      Bbbk:                   ['\u006B',{mathvariant: tc.TexConstant.Variant.DOUBLESTRUCK}],
